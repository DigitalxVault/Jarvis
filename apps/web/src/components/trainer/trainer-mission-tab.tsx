              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <span style={{ fontSize: '7px', color: 'rgba(0,212,255,0.5)', width: '14px' }}>
                      {idx + 1}
                    </span>
                    <input
                      type="text"
                    ...
                    <button
                      ...
                      disabled={idx === 0}
                      style={{ ...ACTION_BTN('dim'), padding: '1px 4px', fontSize: '9px', opacity: idx === 0 ? 0.3 : 1 }}
                    >
                      ↑
                    </button>
                    <button
                      ...
                      style={{ ...ACTION_BTN('dim'), padding: '1px 4px', fontSize: '9px', opacity: idx === waypoints.length - 1 ? 0.3 : 1 }}
                    >
                      ↓
                    </button>
                    <button
