...
export function AlertOverlay({ alerts, className = '' }: AlertOverlayProps) {
  ...
  return (
    <div className={`${className} alert-overlay`}>
      <div
        className={`
          border-l-4 border-r-4 px-2 py-1.5 md:px-6 md:py-3 text-center max-w-full md:max-w-lg mx-auto
          ${colorClass}
        `}
        style={{ letterSpacing: '3px' }}
      >
        <div className="text-[12px] md:text-[14px] font-bold animate-blink">
